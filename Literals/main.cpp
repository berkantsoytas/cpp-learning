...
int main()
{
  ...
  unsigned short int unsigned_short_int{5678U}; //  No special literal unsigned tpye for short

  // 4 Bytes
  const int int_var{55};           // 4 Byte
  signed signed_var{66};           // 4 Byte
  signed int signed_int{77};       // 4 Byte
  unsigned int unsigned_int{555U}; // 4 Byte

  // 4 or 8 Bytes
  long long_var{88L};                         // 4 OR 8 Bytes
  long int long_int{33L};                     // 4 OR 8 Bytes
  signed long signed_long{44l};               // 4 OR 8 Bytes
  signed long int signed_long_int{44l};       // 4 OR 8 Bytes
  unsigned long int unsigned_long_int{555ul}; // 4 OR 8 Bytes

  long long long_long{888ll};                        // 8 Bytes
  long long int long_long_int{999ll};                // 8 Bytes
  signed long long signed_long_long{444ll};          // 8 Bytes
  signed long long int signed_long_long_int{1234ll}; // 8 Bytes
