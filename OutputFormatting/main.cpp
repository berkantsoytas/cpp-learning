...
{
  /*
    Manipualtor(s)          header      Purpose
    std::endl               <ostream>   Insert new line character.
    ----------------------------------------------
    std::flush              <ostream>   Flush the output stream.
    ----------------------------------------------
    std::setw()             <ios>       Changes the width of the next input/output field.
    ----------------------------------------------
    ...
    std::noboolalpha
    ----------------------------------------------
    std::showpos,           <ios>       Show + Sign for positive numbers.
    std::noshowpos
    ----------------------------------------------
    std::dec, std::hex,     <ios>       Controls  the default number systems.
    std::oct
    ----------------------------------------------
    ...
    std::nouppercase
    ----------------------------------------------
    std::fixed,                         Controls floating point output format.
    std::scientific         <ios>
    ----------------------------------------------
